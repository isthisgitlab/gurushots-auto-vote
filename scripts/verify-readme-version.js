    ...
    filesToVerify.forEach((fileInfo) => {
        ...
        const filePatterns = [
            {
                ...
                type: 'GuruShotsAutoVote-x64.exe',
                required: true,
            },
            {
                pattern: /GuruShotsAutoVote-v[\d.]+(?:-[a-zA-Z0-9.]+)?-arm64\.dmg/g,
                type: 'GuruShotsAutoVote-arm64.dmg',
                required: true,
            },
            {
                pattern: /GuruShotsAutoVote-v[\d.]+(?:-[a-zA-Z0-9.]+)?-arm64\.app\.zip/g,
                type: 'GuruShotsAutoVote-arm64.app.zip',
                required: true,
            },
            {
                pattern: /GuruShotsAutoVote-v[\d.]+(?:-[a-zA-Z0-9.]+)?-x86_64\.AppImage/g,
                type: 'GuruShotsAutoVote-x86_64.AppImage',
                required: true,
            },
            {
            ...
            { pattern: /gurucli-v[\d.]+(?:-[a-zA-Z0-9.]+)?-linux/g, type: 'gurucli-linux', required: hasCLISection },
            {
                ...
                type: 'gurucli-linux-arm',
                required: hasCLISection,
            },
        ];
        ...
        filePatterns.forEach(({ pattern, type, required }) => {
            ...
            if (!matches) {
                ...
                const hasCorrectVersion = matches.some(
                    (match) => match.includes(`-v${version}-`) || match.includes(`-v${version}`),
                );
        ...
        const urlPatterns = [
            ...
            },
            {
                ...
                type: 'GuruShotsAutoVote-arm64.app.zip URL',
                required: true,
            },
            {
                pattern:
                ...
                type: 'GuruShotsAutoVote-x86_64.AppImage URL',
                required: true,
            },
            {
                pattern:
        ...
        const commandPatterns = [
            {
                pattern: /chmod \+x GuruShotsAutoVote-v[\d.]+(?:-[a-zA-Z0-9.]+)?-\*\.AppImage/g,
                type: 'chmod AppImage',
                required: content.includes('AppImage'),
            },
            {
                pattern: /\.\/GuruShotsAutoVote-v[\d.]+(?:-[a-zA-Z0-9.]+)?-\*\.AppImage/g,
                type: 'run AppImage',
                required: content.includes('AppImage'),
            },
            // CLI command examples - only required if CLI section exists
            {
                pattern: /chmod \+x gurucli-v[\d.]+(?:-[a-zA-Z0-9.]+)?-mac/g,
                type: 'chmod gurucli-mac',
                required: hasCLISection && content.includes('gurucli-mac'),
            },
            {
                pattern: /\.\/gurucli-v[\d.]+(?:-[a-zA-Z0-9.]+)?-mac/g,
                type: 'run gurucli-mac',
                required: hasCLISection && content.includes('gurucli-mac'),
            },
            {
                pattern: /chmod \+x gurucli-v[\d.]+(?:-[a-zA-Z0-9.]+)?-linux/g,
                type: 'chmod gurucli-linux',
                required: hasCLISection && content.includes('gurucli-linux'),
            },
            {
                pattern: /\.\/gurucli-v[\d.]+(?:-[a-zA-Z0-9.]+)?-linux/g,
                type: 'run gurucli-linux',
                required: hasCLISection && content.includes('gurucli-linux'),
            },
        ];
