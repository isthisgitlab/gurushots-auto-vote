...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | --------------------- |
| **Windows**       | [📥 GuruShotsAutoVote-v1.10.1-x64.exe](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-x64.exe)                 | ~270 MB | Portatīva izpildfaila |
| **macOS (DMG)**   | [📥 GuruShotsAutoVote-v1.10.1-arm64.dmg](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-arm64.dmg)             | ~310 MB | DMG instalētājs       |
| **macOS (APP)**   | [📥 GuruShotsAutoVote-v1.10.1-arm64.app.zip](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-arm64.app.zip)     | ~335 MB | App komplekts (ZIP)   |
| **Linux (x64)**   | [📥 GuruShotsAutoVote-v1.10.1-x86_64.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-x86_64.AppImage) | ~270 MB | AppImage              |
| **Linux (ARM64)** | [📥 GuruShotsAutoVote-v1.10.1-arm64.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-arm64.AppImage)   | ~255 MB | AppImage              |
...
| Platforma                     | Lejupielāde                                                                                                                                    | Izmērs  | Tips           |
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------- | -------------- |
| **Android (8.0+, sānielāde)** | [📥 GuruShotsAutoVote-v1.10.1.apk](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1.apk) | ~160 MB | Parakstīts APK |
...
| Platforma             | Lejupielāde                                                                                                                            | Izmērs  | Tips                  |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------- | --------------------- |
| **macOS CLI**         | [📥 gurucli-v1.10.1-mac](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.10.1-mac)             | ~375 MB | Termināļa izpildfaila |
| **Linux CLI (x64)**   | [📥 gurucli-v1.10.1-linux](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.10.1-linux)         | ~355 MB | Termināļa izpildfaila |
| **Linux CLI (ARM64)** | [📥 gurucli-v1.10.1-linux-arm](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.10.1-linux-arm) | ~350 MB | Termināļa izpildfaila |
...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Windows**                   | [📥 GuruShotsAutoVote-v1.10.1-x64-lite.exe](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-x64-lite.exe)                 |
| **macOS (DMG)**               | [📥 GuruShotsAutoVote-v1.10.1-arm64-lite.dmg](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-arm64-lite.dmg)             |
| **macOS (APP)**               | [📥 GuruShotsAutoVote-v1.10.1-arm64-lite.app.zip](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-arm64-lite.app.zip)     |
| **Linux (x64)**               | [📥 GuruShotsAutoVote-v1.10.1-x86_64-lite.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-x86_64-lite.AppImage) |
| **Linux (ARM64)**             | [📥 GuruShotsAutoVote-v1.10.1-arm64-lite.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-arm64-lite.AppImage)   |
| **Android (8.0+, sānielāde)** | [📥 GuruShotsAutoVote-v1.10.1-lite.apk](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.10.1-lite.apk)                         |
| **macOS CLI**                 | [📥 gurucli-v1.10.1-mac-lite](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.10.1-mac-lite)                                             |
| **Linux CLI (x64)**           | [📥 gurucli-v1.10.1-linux-lite](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.10.1-linux-lite)                                         |
| **Linux CLI (ARM64)**         | [📥 gurucli-v1.10.1-linux-arm-lite](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.10.1-linux-arm-lite)                                 |
...
1. Lejupielādējiet `gurucli-v1.10.1-mac`.
2. `cd ~/Downloads`
3. Padariet izpildāmu: `chmod +x gurucli-v1.10.1-mac`
4. Notīriet karantīnas karogu (tikai pārlūka lejupielādēm): `xattr -d com.apple.quarantine ./gurucli-v1.10.1-mac`
5. Palaidiet: `./gurucli-v1.10.1-mac help`
...
2. Padariet izpildāmu: `chmod +x GuruShotsAutoVote-v1.10.1-*.AppImage` (vai failu pārvaldniekā → Properties → Permissions).
3. Palaidiet: `./GuruShotsAutoVote-v1.10.1-*.AppImage`

**CLI:**

1. Lejupielādējiet `gurucli-v1.10.1-linux` (vai `-linux-arm`).
2. `cd ~/Downloads`
3. `chmod +x gurucli-v1.10.1-linux`
4. `./gurucli-v1.10.1-linux help`
...
1. Telefonā atveriet [jaunākā izlaiduma lapu](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest) un piesitiet `GuruShotsAutoVote-v1.10.1.apk`.
...
```bash
./gurucli-v1.10.1-[platforma] login    # autentificējieties vienreiz (saglabā tokenu)
./gurucli-v1.10.1-[platforma] run      # viens pilns auto-stratēģijas cikls (boost/turbo/auto-iesniegšana/slieksnis-balsošana)
./gurucli-v1.10.1-[platforma] start    # nepārtraukta balsošana (Ctrl+C, lai apturētu)
```
...
```bash
./gurucli-v1.10.1-[platforma] set-global-default exposure 80
./gurucli-v1.10.1-[platforma] set-setting onlyBoost true --challenge=12345
./gurucli-v1.10.1-[platforma] list-settings --challenge=12345
./gurucli-v1.10.1-[platforma] logs --error --lines=50
```
...
- **Ko noteikums dara.** Piešķir iestatījumu **profilu** (jebkurš izaicinājuma iestatījums — balsošana, boost, turbo, …), ieslēdz vai izslēdz **auto-pievienošanos** / **auto-iesniegšanu**, iestata **pievienošanās laiku** (procenti no izaicinājuma ilguma vai stundas pirms beigām) un pievieno must/should-include **foto tagus**. Tukšs lauks nozīmē "noklusējums".
