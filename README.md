...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ------------------- |
| **Windows**       | [📥 GuruShotsAutoVote-v1.11.2-x64.exe](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.11.2-x64.exe)                 | ~270 MB | Portable Executable |
| **macOS (DMG)**   | [📥 GuruShotsAutoVote-v1.11.2-arm64.dmg](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.11.2-arm64.dmg)             | ~310 MB | DMG Installer       |
| **macOS (APP)**   | [📥 GuruShotsAutoVote-v1.11.2-arm64.app.zip](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.11.2-arm64.app.zip)     | ~335 MB | App Bundle (ZIP)    |
...
| Platform                     | Download                                                                                                                                       | Size    | Type       |
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ---------- |
| **Android (8.0+, sideload)** | [📥 GuruShotsAutoVote-v1.11.2.apk](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.11.2.apk) | ~160 MB | Signed APK |
...
| Platform              | Download                                                                                                                               | Size    | Type                |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------- | ------------------- |
| **macOS CLI**         | [📥 gurucli-v1.11.2-mac](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.11.2-mac)             | ~375 MB | Terminal Executable |
| **Linux CLI (x64)**   | [📥 gurucli-v1.11.2-linux](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.11.2-linux)         | ~355 MB | Terminal Executable |
| **Linux CLI (ARM64)** | [📥 gurucli-v1.11.2-linux-arm](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.11.2-linux-arm) | ~350 MB | Terminal Executable |
...
| **Android (8.0+, sideload)** | [📥 GuruShotsAutoVote-v1.11.2-lite.apk](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.11.2-lite.apk)                         |
...
1. Download `gurucli-v1.11.2-mac`.
2. `cd ~/Downloads`
3. Make it executable: `chmod +x gurucli-v1.11.2-mac`
4. Clear the quarantine flag (browser downloads only): `xattr -d com.apple.quarantine ./gurucli-v1.11.2-mac`
5. Run: `./gurucli-v1.11.2-mac help`
...
2. Make it executable: `chmod +x GuruShotsAutoVote-v1.11.2-*.AppImage` (or via file-manager → Properties → Permissions).
3. Run it: `./GuruShotsAutoVote-v1.11.2-*.AppImage`

**CLI:**

1. Download `gurucli-v1.11.2-linux` (or `-linux-arm`).
2. `cd ~/Downloads`
...
1. On the phone, open the [latest release page](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest) and tap `GuruShotsAutoVote-v1.11.2.apk`.
...
```bash
./gurucli-v1.11.2-[platform] login    # authenticate once (saves a token)
./gurucli-v1.11.2-[platform] run      # one full auto-strategy cycle (boost/turbo/auto-submit/threshold-aware vote)
./gurucli-v1.11.2-[platform] start    # continuous voting (Ctrl+C to stop)
```
