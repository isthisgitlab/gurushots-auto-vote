...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ------------------- |
| **Windows**       | [📥 GuruShotsAutoVote-v1.7.0-x64.exe](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.7.0-x64.exe)                 | ~96 MB  | Portable Executable |
| **macOS (DMG)**   | [📥 GuruShotsAutoVote-v1.7.0-arm64.dmg](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.7.0-arm64.dmg)             | ~108 MB | DMG Installer       |
| **macOS (APP)**   | [📥 GuruShotsAutoVote-v1.7.0-arm64.app.zip](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.7.0-arm64.app.zip)     | ~120 MB | App Bundle (ZIP)    |
...
| Platform                     | Download                                                                                                                                     | Size    | Type       |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ---------- |
| **Android (8.0+, sideload)** | [📥 GuruShotsAutoVote-v1.7.0.apk](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.7.0.apk) | ~5.2 MB | Signed APK |
...
| Platform              | Download                                                                                                                             | Size    | Type                |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------- |
| **macOS CLI**         | [📥 gurucli-v1.7.0-mac](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.7.0-mac)             | ~101 MB | Terminal Executable |
| **Linux CLI (x64)**   | [📥 gurucli-v1.7.0-linux](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.7.0-linux)         | ~113 MB | Terminal Executable |
| **Linux CLI (ARM64)** | [📥 gurucli-v1.7.0-linux-arm](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.7.0-linux-arm) | ~111 MB | Terminal Executable |
...
1. Download `gurucli-v1.7.0-mac`.
2. `cd ~/Downloads`
3. Make it executable: `chmod +x gurucli-v1.7.0-mac`
4. Clear the quarantine flag (browser downloads only): `xattr -d com.apple.quarantine ./gurucli-v1.7.0-mac`
5. Run: `./gurucli-v1.7.0-mac help`
...
2. Make it executable: `chmod +x GuruShotsAutoVote-v1.7.0-*.AppImage` (or via file-manager → Properties → Permissions).
3. Run it: `./GuruShotsAutoVote-v1.7.0-*.AppImage`

**CLI:**

1. Download `gurucli-v1.7.0-linux` (or `-linux-arm`).
2. `cd ~/Downloads`
...
1. On the phone, open the [latest release page](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest) and tap `GuruShotsAutoVote-v1.7.0.apk`.
...
```bash
./gurucli-v1.7.0-[platform] login    # authenticate once (saves a token)
./gurucli-v1.7.0-[platform] run      # one full auto-strategy cycle (boost/turbo/fill/threshold-aware vote)
./gurucli-v1.7.0-[platform] start    # continuous voting (Ctrl+C to stop)
```
...
```bash
./gurucli-v1.7.0-[platform] set-global-default exposure 80
./gurucli-v1.7.0-[platform] set-setting onlyBoost true --challenge=12345
./gurucli-v1.7.0-[platform] list-settings --challenge=12345
./gurucli-v1.7.0-[platform] logs --error --lines=50
```
