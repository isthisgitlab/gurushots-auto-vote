...
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|---------------------|
| **Windows**       | [📥 GuruShotsAutoVote-v0.4.3-x64.exe](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.4.3-x64.exe)                 | ~50 MB | Portable Executable |
| **macOS (DMG)**   | [📥 GuruShotsAutoVote-v0.4.3-arm64.dmg](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.4.3-arm64.dmg)             | ~50 MB | DMG Installer       |
| **macOS (APP)**   | [📥 GuruShotsAutoVote-v0.4.3-arm64.app.zip](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.4.3-arm64.app.zip)             | ~50 MB | App Bundle (ZIP)    |
| **Linux (x64)**   | [📥 GuruShotsAutoVote-v0.4.3-x86_64.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.4.3-x86_64.AppImage) | ~50 MB | AppImage            |
| **Linux (ARM64)** | [📥 GuruShotsAutoVote-v0.4.3-arm64.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.4.3-arm64.AppImage)   | ~50 MB | AppImage            |

#### **💻 CLI Applications (For advanced users)**

| Platform              | Download                                                                                                                           | Size   | Type                |
|-----------------------|------------------------------------------------------------------------------------------------------------------------------------|--------|---------------------|
| **macOS CLI**         | [📥 gurucli-v0.4.3-mac](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v0.4.3-mac)             | ~55 MB | Terminal Executable |
| **Linux CLI (x64)**   | [📥 gurucli-v0.4.3-linux](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v0.4.3-linux)         | ~50 MB | Terminal Executable |
| **Linux CLI (ARM64)** | [📥 gurucli-v0.4.3-linux-arm](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v0.4.3-linux-arm) | ~47 MB | Terminal Executable |
...
1. Download the `gurucli-v0.4.3-mac` file
2. Open Terminal
3. Navigate to the download folder: `cd ~/Downloads`
4. Make executable: `chmod +x gurucli-v0.4.3-mac`
5. Run: `./gurucli-v0.4.3-mac`
...
2. **Make Executable**: Right-click the file → Properties → Permissions → Check "Allow executing file as program"
    - Or use terminal: `chmod +x GuruShotsAutoVote-v0.4.3-*.AppImage`
3. **Run**: Double-click the file or run from terminal: `./GuruShotsAutoVote-v0.4.3-*.AppImage`

**CLI App:**

1. Download the appropriate `gurucli-v0.4.3-linux` file
2. Open terminal and navigate to download folder: `cd ~/Downloads`
3. Make executable: `chmod +x gurucli-v0.4.3-linux`
4. Run: `./gurucli-v0.4.3-linux`
...
```
./gurucli-v0.4.3-[platform] login
```

Run a single voting cycle:
```
./gurucli-v0.4.3-[platform] vote
```

Start continuous voting:
```
./gurucli-v0.4.3-[platform] start
```
...
```
./gurucli-v0.4.3-[platform] status
```

Show help:
```
./gurucli-v0.4.3-[platform] help
```
