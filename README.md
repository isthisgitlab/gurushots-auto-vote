...
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|---------------------|
| **Windows**       | [📥 GuruShotsAutoVote-v0.8.0-x64.exe](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.8.0-x64.exe)                 | ~50 MB | Portable Executable |
| **macOS (DMG)**   | [📥 GuruShotsAutoVote-v0.8.0-arm64.dmg](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.8.0-arm64.dmg)             | ~50 MB | DMG Installer       |
| **macOS (APP)**   | [📥 GuruShotsAutoVote-v0.8.0-arm64.app.zip](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.8.0-arm64.app.zip)             | ~50 MB | App Bundle (ZIP)    |
...
| Platform              | Download                                                                                                                           | Size   | Type                |
|-----------------------|------------------------------------------------------------------------------------------------------------------------------------|--------|---------------------|
| **macOS CLI**         | [📥 gurucli-v0.8.0-mac](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v0.8.0-mac)             | ~55 MB | Terminal Executable |
| **Linux CLI (x64)**   | [📥 gurucli-v0.8.0-linux](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v0.8.0-linux)         | ~50 MB | Terminal Executable |
| **Linux CLI (ARM64)** | [📥 gurucli-v0.8.0-linux-arm](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v0.8.0-linux-arm) | ~47 MB | Terminal Executable |
...
1. Download the `gurucli-v0.8.0-mac` file
2. Open Terminal
3. Navigate to the download folder: `cd ~/Downloads`
4. Make executable: `chmod +x gurucli-v0.8.0-mac`
5. Run: `./gurucli-v0.8.0-mac`
...
2. **Make Executable**: Right-click the file → Properties → Permissions → Check "Allow executing file as program"
    - Or use terminal: `chmod +x GuruShotsAutoVote-v0.8.0-*.AppImage`
3. **Run**: Double-click the file or run from terminal: `./GuruShotsAutoVote-v0.8.0-*.AppImage`

**CLI App:**

1. Download the appropriate `gurucli-v0.8.0-linux` file
2. Open terminal and navigate to download folder: `cd ~/Downloads`
3. Make executable: `chmod +x gurucli-v0.8.0-linux`
4. Run: `./gurucli-v0.8.0-linux`
...
```
./gurucli-v0.8.0-[platform] login
```

Run a single voting cycle:
```
./gurucli-v0.8.0-[platform] vote
```

Start continuous voting:
```
./gurucli-v0.8.0-[platform] start
```
...
```
./gurucli-v0.8.0-[platform] status
```

Show help:
```
./gurucli-v0.8.0-[platform] help
```
...
```
./gurucli-v0.8.0-[platform] set-global-default exposure 80
./gurucli-v0.8.0-[platform] set-global-default autoTurbo true
./gurucli-v0.8.0-[platform] list-settings
./gurucli-v0.8.0-[platform] reset-setting lastMinuteThreshold
```
