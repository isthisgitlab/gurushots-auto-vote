...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------- |
| **Windows**       | [📥 GuruShotsAutoVote-v0.11.6-x64.exe](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.11.6-x64.exe)                 | ~50 MB | Portable Executable |
| **macOS (DMG)**   | [📥 GuruShotsAutoVote-v0.11.6-arm64.dmg](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.11.6-arm64.dmg)             | ~50 MB | DMG Installer       |
| **macOS (APP)**   | [📥 GuruShotsAutoVote-v0.11.6-arm64.app.zip](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.11.6-arm64.app.zip)     | ~50 MB | App Bundle (ZIP)    |
| **Linux (x64)**   | [📥 GuruShotsAutoVote-v0.11.6-x86_64.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.11.6-x86_64.AppImage) | ~50 MB | AppImage            |
| **Linux (ARM64)** | [📥 GuruShotsAutoVote-v0.11.6-arm64.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.11.6-arm64.AppImage)   | ~50 MB | AppImage            |

#### **📱 Mobile (Android sideload — no Play Store)**

| Platform                     | Download                                                                                                                                       | Size   | Type       |
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ---------- |
| **Android (8.0+, sideload)** | [📥 GuruShotsAutoVote-v0.11.6.apk](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.11.6.apk) | ~10 MB | Signed APK |
...
| Platform              | Download                                                                                                                               | Size   | Type                |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------- |
| **macOS CLI**         | [📥 gurucli-v0.11.6-mac](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v0.11.6-mac)             | ~55 MB | Terminal Executable |
| **Linux CLI (x64)**   | [📥 gurucli-v0.11.6-linux](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v0.11.6-linux)         | ~50 MB | Terminal Executable |
| **Linux CLI (ARM64)** | [📥 gurucli-v0.11.6-linux-arm](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v0.11.6-linux-arm) | ~47 MB | Terminal Executable |
...
1. Download the `gurucli-v0.11.6-mac` file
2. Open Terminal and navigate to the download folder: `cd ~/Downloads`
3. Make executable: `chmod +x gurucli-v0.11.6-mac`
4. (If downloaded via a browser) clear the Gatekeeper quarantine flag: `xattr -d com.apple.quarantine ./gurucli-v0.11.6-mac`
5. Run: `./gurucli-v0.11.6-mac`
...
2. **Make Executable**: Right-click the file → Properties → Permissions → Check "Allow executing file as program"
    - Or use terminal: `chmod +x GuruShotsAutoVote-v0.11.6-*.AppImage`
3. **Run**: Double-click the file or run from terminal: `./GuruShotsAutoVote-v0.11.6-*.AppImage`

**CLI App:**

1. Download the appropriate `gurucli-v0.11.6-linux` file
2. Open terminal and navigate to download folder: `cd ~/Downloads`
3. Make executable: `chmod +x gurucli-v0.11.6-linux`
4. Run: `./gurucli-v0.11.6-linux`

#### **📱 Android Users (Sideload)**

The Android build is **not on Google Play** — install via direct APK download.

1. **On the phone**, open the [latest release page](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest) and tap `GuruShotsAutoVote-v0.11.6.apk`
...
```
./gurucli-v0.11.6-[platform] login
```

Run a single voting cycle:

```
./gurucli-v0.11.6-[platform] vote
```

Start continuous voting:

```
./gurucli-v0.11.6-[platform] start
```
...
```
./gurucli-v0.11.6-[platform] status
```

Show help:

```
./gurucli-v0.11.6-[platform] help
```
...
```
./gurucli-v0.11.6-[platform] set-global-default exposure 80
./gurucli-v0.11.6-[platform] set-global-default autoTurbo true
./gurucli-v0.11.6-[platform] list-settings
./gurucli-v0.11.6-[platform] reset-setting lastMinuteThreshold
```
