...
| `autoFillSchedule`    | 2@30m, 3@20m, 4@10m | steps          | List of `{count, seconds}` steps: have ≥ `count` entries once ≤ `seconds` remain. Counts 2–20, unique. Replaces `autoFillIntervalMinutes` (migrated automatically).                                                                                                                                |
