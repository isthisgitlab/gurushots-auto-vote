...
1. Download the `gurucli-v0.12.1-mac` file
2. Open Terminal and navigate to the download folder: `cd ~/Downloads`
3. Make executable: `chmod +x gurucli-v0.12.1-mac`
4. (If downloaded via a browser) clear the Gatekeeper quarantine flag: `xattr -d com.apple.quarantine ./gurucli-v0.12.1-mac`
5. Run: `./gurucli-v0.12.1-mac`
...
2. **Make Executable**: Right-click the file → Properties → Permissions → Check "Allow executing file as program"
    - Or use terminal: `chmod +x GuruShotsAutoVote-v0.12.1-*.AppImage`
3. **Run**: Double-click the file or run from terminal: `./GuruShotsAutoVote-v0.12.1-*.AppImage`

**CLI App:**

1. Download the appropriate `gurucli-v0.12.1-linux` file
2. Open terminal and navigate to download folder: `cd ~/Downloads`
3. Make executable: `chmod +x gurucli-v0.12.1-linux`
4. Run: `./gurucli-v0.12.1-linux`
...
```
./gurucli-v0.12.1-[platform] login
```

Run a single voting cycle:

```
./gurucli-v0.12.1-[platform] vote
```

Start continuous voting:

```
./gurucli-v0.12.1-[platform] start
```
...
```
./gurucli-v0.12.1-[platform] status
```

Show help:

```
./gurucli-v0.12.1-[platform] help
```
...
./gurucli-v0.12.1-[platform] set-global-default autoTurbo true
./gurucli-v0.12.1-[platform] list-settings
./gurucli-v0.12.1-[platform] reset-setting lastMinuteThreshold
```
