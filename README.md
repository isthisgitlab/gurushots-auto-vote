...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------- |
| **Windows**       | [📥 GuruShotsAutoVote-v1.3.8-x64.exe](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.8-x64.exe)                 | ~50 MB | Portable Executable |
| **macOS (DMG)**   | [📥 GuruShotsAutoVote-v1.3.8-arm64.dmg](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.8-arm64.dmg)             | ~50 MB | DMG Installer       |
| **macOS (APP)**   | [📥 GuruShotsAutoVote-v1.3.8-arm64.app.zip](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.8-arm64.app.zip)     | ~50 MB | App Bundle (ZIP)    |
| **Linux (x64)**   | [📥 GuruShotsAutoVote-v1.3.8-x86_64.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.8-x86_64.AppImage) | ~50 MB | AppImage            |
| **Linux (ARM64)** | [📥 GuruShotsAutoVote-v1.3.8-arm64.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.8-arm64.AppImage)   | ~50 MB | AppImage            |
...
| Platform                     | Download                                                                                                                                     | Size   | Type       |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ---------- |
| **Android (8.0+, sideload)** | [📥 GuruShotsAutoVote-v1.3.8.apk](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.8.apk) | ~10 MB | Signed APK |
...
| Platform              | Download                                                                                                                             | Size   | Type                |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ------ | ------------------- |
| **macOS CLI**         | [📥 gurucli-v1.3.8-mac](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.3.8-mac)             | ~55 MB | Terminal Executable |
| **Linux CLI (x64)**   | [📥 gurucli-v1.3.8-linux](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.3.8-linux)         | ~50 MB | Terminal Executable |
| **Linux CLI (ARM64)** | [📥 gurucli-v1.3.8-linux-arm](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.3.8-linux-arm) | ~47 MB | Terminal Executable |
...
1. Download `gurucli-v1.3.8-mac`.
2. `cd ~/Downloads`
3. Make it executable: `chmod +x gurucli-v1.3.8-mac`
4. Clear the quarantine flag (browser downloads only): `xattr -d com.apple.quarantine ./gurucli-v1.3.8-mac`
5. Run: `./gurucli-v1.3.8-mac help`
...
2. Make it executable: `chmod +x GuruShotsAutoVote-v1.3.8-*.AppImage` (or via file-manager → Properties → Permissions).
3. Run it: `./GuruShotsAutoVote-v1.3.8-*.AppImage`

**CLI:**

1. Download `gurucli-v1.3.8-linux` (or `-linux-arm`).
2. `cd ~/Downloads`
3. `chmod +x gurucli-v1.3.8-linux`
4. `./gurucli-v1.3.8-linux help`

#### 📱 Android (sideload)

The Android build is **not on Google Play** — install via direct APK download.

1. On the phone, open the [latest release page](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest) and tap `GuruShotsAutoVote-v1.3.8.apk`.
...
```bash
./gurucli-v1.3.8-[platform] login    # authenticate once (saves a token)
./gurucli-v1.3.8-[platform] run      # one full auto-strategy cycle (boost/turbo/fill/threshold-aware vote)
./gurucli-v1.3.8-[platform] start    # continuous voting (Ctrl+C to stop)
```
...
```bash
./gurucli-v1.3.8-[platform] set-global-default exposure 80
./gurucli-v1.3.8-[platform] set-setting onlyBoost true --challenge=12345
./gurucli-v1.3.8-[platform] list-settings --challenge=12345
./gurucli-v1.3.8-[platform] logs --error --lines=50
```
