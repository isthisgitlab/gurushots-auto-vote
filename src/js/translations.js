...
const translations = {
    ...
    lv: {
        ...
        app: {
            ...
            resetToDefaultNotSaved: 'Atiestatīt uz noklusējumu (nesaglabāts līdz Saglabāt)',
            ...
            resetAllConfirmDetails: 'Tas atiestatīs:\n• Visus lietotāja saskarnes iestatījumus (tēmu, valodu, laika joslu)\n• Visus globālos izaicinājumu noklusējumus\n• Programmas preferences\n• Logu pozīcijas un izmērus\n• Pielāgotas laika joslas\n• Lietotājvārdu un ielogošanās sesijas preferences\n\nTiks saglabāta tikai jūsu ielogošanās pilnvara, pēdējās atjauninājuma pārbaudes laiks, mock režīma iestatījums un API galvenes.\n\nŠo darbību nevar atsaukt.',
            resetAllSuccess: 'Visi iestatījumi ir atiestatīti uz noklusējuma vērtībām. Lapa tiks pārlādēta, lai lietotu izmaiņas.',
            save: 'Saglabāt',
            seconds: 'sekunde(s)',
