...
(function (root, factory) {
    ...
    return {
        ...
        app: {
            ...
            titleTagRules: 'Izaicinājumu noteikumi',
            titleTagRulesDesc:
            ...
            titleRuleConditionsHint:
                'Jāatbilst katram aizpildītajam laukam; tukšs lauks netiek ņemts vērā. Izaicinājuma tags ir paša izaicinājuma tags (Exhibition, Comm, …), nevis foto tags. Ilgums ir izaicinājuma garums no sākuma līdz beigām: 24 h = 1 diena, 168 h = 7 dienas.',
            titleRuleChallengeTag: 'Izaicinājuma tags',
            titleRuleChallengeTagPlaceholder: 'piem., Exhibition',
            titleRuleType: 'Izaicinājuma veids',
            titleRuleTypePlaceholder: 'Jebkurš veids',
            titleRulePics: 'Bildes',
            ...
            titleRuleAutoJoin: 'Automātiski pievienoties',
            titleRuleAutoFill: 'Auto-iesniegšana',
            titleRulePercentElapsed: 'Pievienoties pēc',
            titleRuleJoinWindow: 'Vai stundas pirms beigām',
            titleRuleJoinWindowPlaceholder: 'noklusējums',
            titleRuleOverridesLabel: 'Uzvedība',
            titleRuleBroadWarning:
                'Šim noteikumam nav nosaukuma, tāpēc tas to ieslēdz katram atbilstošajam izaicinājumam — tas var tērēt monētas vai foto veselai izaicinājumu grupai.',
            titleRuleOrderHint:
                'Noteikumi tiek pārbaudīti no augšas uz leju: katram iestatījumam uzvar pirmais atbilstošais noteikums, kas to iestata, bet tas, ko tas atstāj tukšu, nāk no nākamā atbilstošā noteikuma, tad no globālā noklusējuma.',
            titleRuleSortDefault: 'Kārtot pēc noklusējuma secības',
            ...
            noTitleTagRules:
                'Vēl nav noteikumu. Pievieno vienu, lai atlasītu izaicinājumus pēc nosaukuma, taga, veida, bilžu skaita vai ilguma.',
