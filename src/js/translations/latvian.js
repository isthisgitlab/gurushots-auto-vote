...
(function (root, factory) {
    ...
    return {
        ...
        app: {
            ...
            visualNoMatch:
                'Vizuālā pārbaudē neviens foto neatbilda izaicinājumam. Vieta palika tukša. Izvēlies foto manuāli.',
            ...
            fillWithoutTagMatchDesc:
                'Attiecas tikai tad, ja ir iestatīti obligātie tagi. Tā kā foto jāsakrīt ar visiem tagiem, tas notiek biežāk, kad pieprasīti vairāki tagi. Kad ieslēgts (noklusējums), ja neviens no taviem foto nesakrīt ar visiem šiem tagiem, tik un tā tiek pievienots labākais pieejamais foto, lai vieta nepaliek tukša. Kad izslēgts, vieta paliek tukša, līdz parādās foto, kas sakrīt ar visiem tagiem. Ja izaicinājumam pieejama attēlu pārbaude, vieta var palikt tukša arī tad, ja neviens foto nešķiet piemērots.',
            emergencyFill: 'Ārkārtas aizpilde',
            emergencyFillDesc:
                'Drošības tīkls, kas darbojas izaicinājuma pēdējās minūtēs, kad auto-aizpilde citādi atstātu foto vietas tukšas — vai nu tāpēc, ka auto-aizpilde ir izslēgta, vai tāpēc, ka obligātie tagi nesakrīt ne ar vienu foto un "Aizpildīt arī bez tagu sakritības" ir izslēgts. Kad izaicinājumam līdz beigām atlicis tik daudz laika, atlikušās vietas tiek aizpildītas ar labākajiem pieejamajiem foto, pat ja tie nesakrīt ar taviem tagiem. Tas apzināti ignorē šos iestatījumus. Ja izaicinājumam pieejama attēlu pārbaude, vieta tomēr var palikt tukša, ja neviens foto nešķiet piemērots. Šajā pašā logā tā arī izmanto jebkuru pieejamo Boost un jebkuru iegūto Turbo — pat ja "Auto-pielietot Boost" vai "Auto-pielietot Turbo" izaicinājumam ir izslēgts — lai tie netiktu izniekoti, kad izaicinājums beidzas. Grafiskajā lietotnē ievada kā stundas un minūtes. Noklusējums 5 minūtes; iestati 0, lai izslēgtu (kas izslēdz arī šo pēdējās minūtes Boost/Turbo ignorēšanu). Padoms: turi šo logu ne garāku par pēdējās minūtes slieksni (noklusējums 10 minūtes), lai lietotne bieži pārbauda visu tā laiku.',
            emergencyFillHelp:
