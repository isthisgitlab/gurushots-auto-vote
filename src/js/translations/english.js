...
module.exports = {
    ...
    app: {
        ...
        scenarioNone: 'None',
        scenarioMissingOption: '{name} (missing — nothing runs)',
        scenarios: 'Scenarios',
        scenariosDesc:
            'Your own multi-day plans: phases with their own settings, and rules that enter, swap, boost or wait at the times you choose. Assign one per challenge or with a challenge rule. Changes here are saved immediately.',
        scenariosLoadError: "Scenarios couldn't be loaded. Close and reopen the settings to try again.",
        scenariosEmpty: 'No scenarios yet. Start from a template or import one someone shared.',
        scenarioErrorNext: 'Fix it and try again.',
        scenarioStartsIn: 'starts in phase {phase}',
        scenarioPhaseSummary: 'Phase {phase}: {rules} rule(s)',
        scenarioSpends: 'Spends: {actions}',
        scenarioSpendsNothing: 'Spends nothing.',
        scenarioLimits: 'Limits: {limits}',
        scenarioNoLimits: 'No spending limits.',
        scenarioImportInvalid: "This scenario can't be imported because the file has problems.",
        scenarioImportFailed: "The scenario wasn't imported.",
        scenarioImportLabel: 'Paste the scenario JSON',
        scenarioOverwrite: 'Replace my scenario "{name}"',
        scenarioPreview: 'Check',
        scenarioImportConfirm: 'Import',
        scenarioImport: 'Import…',
        scenarioExport: 'Export',
        scenarioExportFailed: "The scenario couldn't be exported — it may have been deleted meanwhile.",
        scenarioExportHint: 'Copy this text to share or back up the scenario.',
        scenarioExportLabel: 'Scenario {name} as JSON',
        scenarioExportClose: 'Hide',
        scenarioRename: 'Rename',
        scenarioRenameLabel: 'New scenario name',
        scenarioRenameSave: 'Save name',
        scenarioRenameFailed: "The scenario wasn't renamed.",
        scenarioDelete: 'Delete',
        scenarioDeleteConfirm: 'Click again to delete',
        scenarioDeleteFailed: "The scenario couldn't be deleted — it may already be gone.",
        scenarioPhaseCount: 'Phases: {count}',
        scenarioTemplatePick: 'Start from a template…',
        scenarioAddTemplate: 'Add copy',
        scenarioTemplateFailed: "The template copy wasn't saved.",
        scenarioStatusMissing:
            'Scenario "{name}" no longer exists — nothing runs. Pick another in the challenge settings.',
        scenarioStatusCorrupt:
            'Scenario "{name}" progress is unreadable, so it is paused. Reset it (scenario-reset) to start the plan again.',
        scenarioStatusPhase: 'phase {phase}',
        ...
        sbCond_dailyWindow: 'Time of day',
        sbCond_beforeEnd: 'Time left until the end',
        sbCond_afterStart: 'Time since the start',
        sbCond_inPhaseFor: 'Time in this phase',
        sbCond_elapsedPercent: 'Share of the challenge run (%)',
        sbCond_entries: 'Number of entries',
        sbCond_freeSlots: 'Free entry slots',
        sbCond_exposure: 'Exposure (%)',
        sbCond_challengeRank: 'My rank in the challenge',
        sbCond_challengeVotes: 'My votes in the challenge',
        sbCond_boostState: 'Boost state',
        sbCond_turboState: 'Turbo state',
        sbCond_balance: 'My balance',
        sbCond_memorySet: 'A remembered photo exists',
        sbCond_entry: 'One of my entries',
        sbCond_all: 'All of these',
        sbCond_any: 'Any of these',
        sbCond_not: 'Not this',
        sbAct_enterPhoto: 'Enter a photo (new entry)',
        sbAct_swap: 'Swap an entry',
        sbAct_boost: 'Boost an entry',
        sbAct_turbo: 'Turbo an entry',
        sbAct_unlockBoost: 'Unlock the boost with a key',
        sbAct_fillExposure: 'Fill exposure (spends a fill)',
        sbAct_vote: 'Vote up to an exposure',
        sbAct_remember: "Remember an entry's photo",
        sbAct_forget: 'Forget a remembered photo',
        sbAct_goto: 'Go to a phase',
        sbAct_notify: 'Send me a notification',
        sbSel_slot: 'Entry in slot',
        sbSel_memory: 'The remembered photo',
        sbSel_fastest: 'Fastest (votes per hour)',
        sbSel_mostVotes: 'Most votes',
        sbSel_fewestVotes: 'Fewest votes',
        sbSel_bestRank: 'Best rank',
        sbSel_worstRank: 'Worst rank',
        sbSel_boosted: 'The boosted one',
        sbSel_turbo: 'The turbo one',
        sbEntryField_votes: 'votes',
        sbEntryField_rank: 'rank',
        sbEntryField_votesPerHour: 'votes per hour',
        sbEntryField_speedRatio: 'speed vs my other entries (×)',
        sbEntryField_boosted: 'is boosted',
        sbEntryField_turbo: 'has turbo',
        sbEntryField_boosting: 'is boosting now',
        sbRepeat_always: 'Every run while it holds',
        sbRepeat_once: 'Only once',
        ...
        sbState_boost_UNAVAILABLE: 'Unavailable',
        sbState_turbo_FREE: 'Free to play',
        sbState_turbo_IN_PROGRESS: 'Game in progress',
        sbState_turbo_TIMER: 'Waiting on its timer',
        sbState_turbo_WON: 'Won',
        sbState_turbo_LOCKED: 'Locked',
        sbState_turbo_USED: 'Used',
        sbCurrency_keys: 'keys',
        sbCurrency_swaps: 'swaps',
        sbCurrency_fills: 'fills',
        sbCurrency_coins: 'coins',
        sbField_from: 'From',
        sbField_to: 'To',
        sbField_min: 'At least',
        sbField_max: 'At most',
        sbField_op: 'Comparison',
        sbField_value: 'Value',
        sbField_in: 'Any of',
        sbField_currency: 'Currency',
        sbField_slot: 'Memory slot',
        sbField_select: 'Which entry',
        sbField_field: 'What',
        sbField_window: 'Measured over',
        sbField_of: 'Conditions',
        sbField_condition: 'Condition',
        sbField_photo: 'Photo',
        sbField_remember: 'Remember it as',
        sbField_entry: 'Which entry',
        sbField_with: 'Swap in',
        sbField_rememberRemoved: 'Remember the removed photo as',
        sbField_rememberAdded: 'Remember the added photo as',
        sbField_toExposure: 'Up to exposure (%)',
        sbField_phase: 'Phase',
        sbField_message: 'Message',
        sbField_index: 'Slot',
        sbField_skipProtected: 'Skip boosted/turbo entries',
        sbNew: 'New scenario',
        sbEdit: 'Edit',
        sbTitleNew: 'New scenario',
        sbTitleEdit: 'Edit scenario',
        sbTabBuilder: 'Builder',
        sbTabJson: 'JSON',
        sbName: 'Name',
        sbDescription: 'Description',
        sbStart: 'Starts in phase',
        sbLimits: 'Spending limits (empty = no limit)',
        sbPhases: 'Phases',
        sbAddPhase: 'Add phase',
        sbPhaseName: 'Phase name',
        sbRemovePhase: 'Remove phase',
        sbPhaseSettings: 'Settings while in this phase',
        sbAddSetting: 'Add setting',
        sbPickSetting: 'Pick a setting…',
        sbNoSettings: 'No setting changes — normal settings apply.',
        sbRules: 'Rules (the first ready one runs)',
        sbAddRule: 'Add rule',
        sbRuleLabel: 'Rule name',
        sbRepeat: 'Runs',
        sbConditions: 'When all of these hold',
        sbConditionsEmpty: 'No conditions — it is always ready.',
        sbAddCondition: 'Add condition',
        sbActions: 'Then do',
        sbAddAction: 'Add action',
        sbPickType: 'Pick…',
        sbRemove: 'Remove',
        sbMoveUp: 'Move up',
        sbMoveDown: 'Move down',
        sbSave: 'Save scenario',
        sbSaveFailed: 'The scenario was not saved because it has problems.',
        sbJsonHint: 'Edit the whole scenario as JSON. Changes show in the builder once the JSON is valid.',
        sbJsonInvalid: 'This is not valid JSON yet — the builder keeps the last valid version.',
        sbSimulate: 'Simulate',
        sbSimulateOn: 'Simulate on challenge',
        sbSimulatePick: 'Pick a challenge…',
        sbSimulateAssume: 'Assumes every step succeeds and the challenge data stays as it is now.',
        sbSimulateNothing: 'Nothing would run.',
        sbSimulateFailed: 'The simulation could not run.',
        sbStop_closed: 'Stops: the challenge closes.',
        sbStop_idle: 'Stops: nothing more is time-based — the plan then waits on votes, rank or boost.',
        sbStop_halted: 'Stops: the scenario halts.',
        sbStop_limit: 'Stops: only the first steps are shown.',
        sbPhotoBest: 'The best matching photo',
        sbPhotoMemory: 'A remembered photo',
        sbSlotLast: 'last',
        sbTrue: 'yes',
        sbFalse: 'no',
        sbToPhase: 'then phase {phase}',
        // Auto-Join settings
        ...
        autoExposureFillAfterStartDesc: 'Fill only once the challenge has been running this long. 0 = no condition.',
        ...
        autoExposureFillMaxDesc: 'Stop auto-filling once this many fills were spent automatically on this challenge.',
        ...
        scheduledFillNoTimesHint: 'No voting time configured — scheduled voting is inactive until you set one below.',
