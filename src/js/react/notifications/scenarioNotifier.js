 ...
 */
export function createRendererScenarioNotifier({ getSettings, getScenarioStatus, translate, deliver, log }) {
    return createScenarioNotifier({
        isEnabled: async () => (await getSettings())?.notifyOnScenario !== false,
