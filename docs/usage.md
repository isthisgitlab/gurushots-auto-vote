...
```bash
./gurucli-v1.11.2-[platform] set-global-default exposure 80
./gurucli-v1.11.2-[platform] set-setting onlyBoost true --challenge=12345
./gurucli-v1.11.2-[platform] list-settings --challenge=12345
./gurucli-v1.11.2-[platform] logs --error --lines=50
```
