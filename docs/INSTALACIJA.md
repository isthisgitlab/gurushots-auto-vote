...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | --------------------- |
| **Windows**       | [📥 GuruShotsAutoVote-v1.3.1-x64.exe](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.1-x64.exe)                 | ~50 MB | Portatīva izpildfaila |
| **macOS (DMG)**   | [📥 GuruShotsAutoVote-v1.3.1-arm64.dmg](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.1-arm64.dmg)             | ~50 MB | DMG instalētājs       |
| **macOS (APP)**   | [📥 GuruShotsAutoVote-v1.3.1-arm64.app.zip](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.1-arm64.app.zip)     | ~50 MB | App komplekts (ZIP)   |
| **Linux (x64)**   | [📥 GuruShotsAutoVote-v1.3.1-x86_64.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.1-x86_64.AppImage) | ~50 MB | AppImage              |
| **Linux (ARM64)** | [📥 GuruShotsAutoVote-v1.3.1-arm64.AppImage](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.1-arm64.AppImage)   | ~50 MB | AppImage              |
...
| Platforma                     | Lejupielāde                                                                                                                                  | Izmērs | Tips           |
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------ | -------------- |
| **Android (8.0+, sānielāde)** | [📥 GuruShotsAutoVote-v1.3.1.apk](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v1.3.1.apk) | ~10 MB | Parakstīts APK |
...
| Platforma             | Lejupielāde                                                                                                                          | Izmērs | Tips                  |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ------ | --------------------- |
| **macOS CLI**         | [📥 gurucli-v1.3.1-mac](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.3.1-mac)             | ~55 MB | Termināļa izpildfaila |
| **Linux CLI (x64)**   | [📥 gurucli-v1.3.1-linux](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.3.1-linux)         | ~50 MB | Termināļa izpildfaila |
| **Linux CLI (ARM64)** | [📥 gurucli-v1.3.1-linux-arm](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/gurucli-v1.3.1-linux-arm) | ~47 MB | Termināļa izpildfaila |
...
1. Lejupielādējiet `gurucli-v1.3.1-mac`.
2. `cd ~/Downloads`
3. Padariet izpildāmu: `chmod +x gurucli-v1.3.1-mac`
4. Notīriet karantīnas karogu (tikai pārlūka lejupielādēm): `xattr -d com.apple.quarantine ./gurucli-v1.3.1-mac`
5. Palaidiet: `./gurucli-v1.3.1-mac help`
...
2. Padariet izpildāmu: `chmod +x GuruShotsAutoVote-v1.3.1-*.AppImage` (vai failu pārvaldniekā → Properties → Permissions).
3. Palaidiet: `./GuruShotsAutoVote-v1.3.1-*.AppImage`

**CLI:**

1. Lejupielādējiet `gurucli-v1.3.1-linux` (vai `-linux-arm`).
2. `cd ~/Downloads`
3. `chmod +x gurucli-v1.3.1-linux`
4. `./gurucli-v1.3.1-linux help`

#### 📱 Android (sānielāde)

Android versija **nav pieejama Google Play** — instalācija notiek caur tiešu APK lejupielādi.

1. Telefonā atveriet [jaunākā izlaiduma lapu](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest) un piesitiet `GuruShotsAutoVote-v1.3.1.apk`.
...
```bash
./gurucli-v1.3.1-[platforma] login    # autentificējieties vienreiz (saglabā tokenu)
./gurucli-v1.3.1-[platforma] run      # viens pilns auto-stratēģijas cikls (boost/turbo/aizpilde/slieksnis-balsošana)
./gurucli-v1.3.1-[platforma] start    # nepārtraukta balsošana (Ctrl+C, lai apturētu)
```
...
```bash
./gurucli-v1.3.1-[platforma] set-global-default exposure 80
./gurucli-v1.3.1-[platforma] set-setting onlyBoost true --challenge=12345
./gurucli-v1.3.1-[platforma] list-settings --challenge=12345
./gurucli-v1.3.1-[platforma] logs --error --lines=50
```
