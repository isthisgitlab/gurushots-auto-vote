...
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|-----------------------|
| **Windows**       | [📥 GuruShotsAutoVote-v0.3.0-beta.1-x64.exe](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.3.0-beta.1-x64.exe)                 | ~50 MB | Portatīva izpildfaila |
| **macOS**         | [📥 GuruShotsAutoVote-v0.3.0-beta.1-arm64.dmg](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest/download/GuruShotsAutoVote-v0.3.0-beta.1-arm64.dmg)             | ~50 MB | DMG instalētājs       |
...
2. **Padarīt izpildāmu**: Labais klikšķis uz faila → Properties → Permissions → Atzīmējiet "Allow executing file as program"
   - Vai izmantojiet termināli: `chmod +x GuruShotsAutoVote-v0.3.0-beta.1-*.AppImage`
3. **Palaist**: Veiciet dubultklikšķi uz faila vai palaidiet no termināļa: `./GuruShotsAutoVote-v0.3.0-beta.1-*.AppImage`
...
1. Izveidojiet `.desktop` failu:
   ...
   Exec=/pilns/ceļš/uz/GuruShotsAutoVote-v0.3.0-beta.1-x86_64.AppImage
   Icon=
   Type=Application
   Categories=Utility;
   EOL
