...
1. Lejupielādējiet `gurucli-v1.0.0-mac`.
2. `cd ~/Downloads`
3. Padariet izpildāmu: `chmod +x gurucli-v1.0.0-mac`
4. Notīriet karantīnas karogu (tikai pārlūka lejupielādēm): `xattr -d com.apple.quarantine ./gurucli-v1.0.0-mac`
5. Palaidiet: `./gurucli-v1.0.0-mac help`
...
2. Padariet izpildāmu: `chmod +x GuruShotsAutoVote-v1.0.0-*.AppImage` (vai failu pārvaldniekā → Properties → Permissions).
3. Palaidiet: `./GuruShotsAutoVote-v1.0.0-*.AppImage`

**CLI:**

1. Lejupielādējiet `gurucli-v1.0.0-linux` (vai `-linux-arm`).
2. `cd ~/Downloads`
...
1. Telefonā atveriet [jaunākā izlaiduma lapu](https://github.com/isthisgitlab/gurushots-auto-vote/releases/latest) un piesitiet `GuruShotsAutoVote-v1.0.0.apk`.
